...
class ServiceGroup {
    ...
    private static components(): ActionRowBuilder<MessageActionRowComponentBuilder> {
    ...
    private async offer(
        ...
        const builder = ServiceGroup.embed(
            "ofreciendo",
            interaction.user, 
            title, 
            description, 
        ...
        await interaction.reply({ embeds: [builder], components: [ ServiceGroup.components() ] });
    }
